...
import InventoryProductsCategoriesComponent from '../RenderedComponents/InventoryProductsCategoriesComponent';
...
const InventoryProductsCategories = () => {
   //    const { 
      ...
      <>
        <FlatList
          ...
          renderItem={({index, item}) =>
           <InventoryProductsCategoriesComponent
            item={item}
           />}
          numColumns={2}
...
export default InventoryProductsCategories;
