...
import ReportsProductsCategoriesComponent from '../RenderedComponents/ReportsProductsCategoriesComponent';
...
const ReportsProductsCategories = ({navigation}) => {
      ...
      <>
        <FlatList
          ...
          renderItem={({index, item}) =>
           <ReportsProductsCategoriesComponent item={item}
           />}
          numColumns={2}
...
export default ReportsProductsCategories;
