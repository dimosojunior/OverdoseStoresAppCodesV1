...
import AllClosedOrdersProductCategoriesComponent from '../RenderedComponents/AllClosedOrdersProductCategoriesComponent';
...
const AllClosedOrdersProductCategories = ({navigation}) => {
      ...
      <>
        <FlatList
          ...
          renderItem={({index, item}) =>
           <AllClosedOrdersProductCategoriesComponent item={item}
           />}
          numColumns={2}
...
export default AllClosedOrdersProductCategories;
