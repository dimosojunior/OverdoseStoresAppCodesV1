...
export default function ViewProducts({navigation, route}) {
    ...
    ProductImageBackView,
    ProductImageLeftSideView,
    ProductImageRightSideView,
    id 
   } = route.params
 ...
 const images = [
    { src: ProductImage, name: "ProductImage" },
    { src: ProductImageFrontView, name: "Front View of the Product" },
    { src: ProductImageBackView, name: "Back View of the Product" },
    { src: ProductImageLeftSideView, name: "Side Left View of the Product" },
     { src: ProductImageRightSideView, name: "Side Right View of the Product" },
...
<View style={globalStyles.MainLeftContainerViewProduct}>
   {images[currentImageIndex].src ?
                    <Image
                      ...
                      source={{ uri: EndPoint + '/' + images[currentImageIndex].src }}
                    /> :
                    <Image
                      style={globalStyles.MainLeftContainerMainImageViewProduct}
