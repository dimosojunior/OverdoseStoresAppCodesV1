...
const InventoryProductsCategoriesComponent = ({item}) => {
  const {width, height} = Dimensions.get('window');
 ...
 let [fontsLoaded] = useFonts({
  ...
  return (
    ...
    style={globalStyles.OverdoseProductsContainer}
      onPress={() => navigation.navigate('Inventory Products In Stores', item)}>
...
export default InventoryProductsCategoriesComponent;
