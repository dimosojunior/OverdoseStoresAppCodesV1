...
const ReportsProductsCategoriesComponent = ({item}) => {
  const {width, height} = Dimensions.get('window');
 ...
 let [fontsLoaded] = useFonts({
  ...
  return (
    ...
    style={globalStyles.OverdoseProductsContainer}
      onPress={() => navigation.navigate('Reports For Specific Category', item)}>
...
export default ReportsProductsCategoriesComponent;
