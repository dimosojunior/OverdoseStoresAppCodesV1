...
const SlidingServices =({services}) => {
...
activeOpacity={1}
onPress = {() => navigation.navigate('All services', item)}
>
...
},{color:theme.color},{backgroundColor:theme.backgroundColor}]}>{item.servicesName}</Text>
</TouchableOpacity>*/}
...
<TouchableOpacity>
<Text style={[globalStyles.Articlesheadertext,{color:theme.color}]}>Our Services</Text>
</TouchableOpacity>
