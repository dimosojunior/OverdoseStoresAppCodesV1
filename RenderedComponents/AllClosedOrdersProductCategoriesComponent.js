...
const AllClosedOrdersProductCategoriesComponent = ({item}) => {
  const {width, height} = Dimensions.get('window');
 ...
 let [fontsLoaded] = useFonts({
  ...
  return (
    ...
    style={globalStyles.OverdoseProductsContainer}
      onPress={() => navigation.navigate('All Closed Orders By Categories', item)}>
...
export default AllClosedOrdersProductCategoriesComponent;
